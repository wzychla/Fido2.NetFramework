...
namespace Fido2NetLib
{
    ...
    public class AssertionOptions : Fido2ResponseBase
    {
        ...
        {
            return JsonConvert.SerializeObject( this, FidoModelSerializerContext.Default.AssertionOptions );
        }

        public static AssertionOptions FromJson( string json )
        {
            return JsonConvert.DeserializeObject<AssertionOptions>( json, FidoModelSerializerContext.Default.AssertionOptions );
        }
    }
}
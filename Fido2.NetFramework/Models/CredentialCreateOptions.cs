...
namespace Fido2NetLib {
    ...
    public sealed class CredentialCreateOptions : Fido2ResponseBase
    {
        ...
        {
            return JsonConvert.SerializeObject( this, FidoModelSerializerContext.Default.CredentialCreateOptions );
        }

        public static CredentialCreateOptions FromJson( string json )
        {
            return JsonConvert.DeserializeObject<CredentialCreateOptions>( json, FidoModelSerializerContext.Default.CredentialCreateOptions );
        }
    }
    ...
    public sealed class PubKeyCredParam
    {
        ...
        public static readonly PubKeyCredParam ES256 = new PubKeyCredParam(COSE.Algorithm.ES256); // External authenticators support the ES256 algorithm
        public static readonly PubKeyCredParam ES384 = new PubKeyCredParam(COSE.Algorithm.ES384);
        public static readonly PubKeyCredParam ES512 = new PubKeyCredParam(COSE.Algorithm.ES512);
        public static readonly PubKeyCredParam RS256 = new PubKeyCredParam(COSE.Algorithm.RS256); // Supported by windows hello
        public static readonly PubKeyCredParam RS384 = new PubKeyCredParam(COSE.Algorithm.RS384);
        public static readonly PubKeyCredParam RS512 = new PubKeyCredParam(COSE.Algorithm.RS512);
        public static readonly PubKeyCredParam PS256 = new PubKeyCredParam(COSE.Algorithm.PS256);
        public static readonly PubKeyCredParam PS384 = new PubKeyCredParam(COSE.Algorithm.PS384);
        public static readonly PubKeyCredParam PS512 = new PubKeyCredParam(COSE.Algorithm.PS512);
        public static readonly PubKeyCredParam Ed25519 = new PubKeyCredParam(COSE.Algorithm.EdDSA);
    }

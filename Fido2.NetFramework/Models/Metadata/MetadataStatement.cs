...
namespace Fido2NetLib
{
    ...
    public class MetadataStatement
    {
        ...
        /// </summary>
        [JsonProperty( "authenticatorVersion" ), Required]
        ...
        /// </summary>
        [JsonProperty( "protocolFamily" ), Required]
        ...
        /// </summary>
        [JsonProperty( "publicKeyAlgAndEncodings" ), Required]
        ...
        /// </summary>
        [JsonProperty( "keyProtection" ), Required]
        ...
        /// </summary>
        [JsonProperty( "matcherProtection" ), Required]
        ...
        /// </summary>
        [JsonProperty( "tcDisplay" ), Required]
        ...
        /// </summary>
        [JsonProperty( "attestationRootCertificates" ), Required]

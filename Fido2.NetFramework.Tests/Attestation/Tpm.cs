...
//            var ex = Assert.ThrowsExceptionAnyAsync<CryptographicException>(() => MakeAttestationResponseAsync());
//            Assert.AreEqual("Unknown format in import.", ex.Result.Message);
//        }
...
//        var ex = Assert.ThrowsExceptionAsync<Fido2VerificationException>(() => MakeAttestationResponseAsync());
//        Assert.AreEqual("SAN missing TPMManuTestMethodurer, TPMModel, or TPMVersion from TPM attestation certificate", ex.Result.Message);
//    }
...
//        var ex = Assert.ThrowsExceptionAsync<Fido2VerificationException>(() => MakeAttestationResponseAsync());
//        Assert.AreEqual("Invalid TPM manuTestMethodurer found parsing TPM attestation", ex.Result.Message);
//    }

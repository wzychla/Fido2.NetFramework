...
namespace Test
{
    ...
    public class CryptoUtilsTests
    {
        ...
        public void TestCertInCRLFalseCase()
        {
            ...
            Assert.IsFalse( CryptoUtils.IsCertInCRL( crl, cert ) );
        }
        ...
        public void TestCertInCRLTrueCase()
        {
            ...
            Assert.IsTrue( CryptoUtils.IsCertInCRL( crl, cert ) );
        }
        ...
        public void TestValidateTrustChainRootAnchor()
        {
            ...
            Assert.IsTrue( CryptoUtils.ValidateTrustChain( trustPath, attestationRootCertificates ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( trustPath, trustPath ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( attestationRootCertificates, attestationRootCertificates ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( attestationRootCertificates, trustPath ) );
        }
        ...
        public void TestValidateTrustChainSubAnchor()
        {
            ...
            Assert.IsFalse( 0 == attestationRootCertificates[0].Issuer.CompareTo( attestationRootCertificates[0].Subject ) );
            Assert.IsTrue( CryptoUtils.ValidateTrustChain( trustPath, attestationRootCertificates ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( trustPath, trustPath ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( attestationRootCertificates, attestationRootCertificates ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( attestationRootCertificates, trustPath ) );
        ...
        public void TestValidateTrustChainSelf()
        {
            ...
            Assert.IsTrue( CryptoUtils.ValidateTrustChain( certs, certs ) );
            Assert.IsFalse( CryptoUtils.ValidateTrustChain( certs, otherCerts ) );
        }
    }
}
...
//            Assert.AreEqual( 1, staticClient.GetBLOBAsyncCount );

//            Assert.IsTrue( entry.MetadataStatement.Description == "Security Key by Yubico with NFC" );
...
//            Assert.AreEqual( itemEntry.AaGuid, entryIdGuid );
...
//            Assert.AreEqual( 2, staticClient.GetBLOBAsyncCount );
